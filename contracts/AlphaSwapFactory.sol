...
contract AlphaSwapFactory is IUniswapV2Factory {
    ...
    bytes32 public constant INIT_CODE_PAIR_HASH = keccak256(abi.encodePacked(type(AlphaSwapPair).creationCode));
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        bytes memory bytecode = type(AlphaSwapPair).creationCode;
